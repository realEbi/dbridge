# table-identifiers Specification

## Purpose

Provide executable server-owned table identifiers and literal scoped metadata identity while preserving existing DSP callers.
